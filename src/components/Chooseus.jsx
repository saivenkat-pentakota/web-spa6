...
<img className="img-fluid w-100" src={featureImg} alt ="featureimg"/>
<span className="position-absolute top-50 start-100 translate-middle bg-white rounded-circle d-none d-lg-block" style={{width: "120px", height: "120px"}}></span>
